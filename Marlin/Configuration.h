...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define LEFT_PROBE_BED_POSITION 18     //left  > MIN_PROBE_X (max(X_MIN_POS, X_MIN_POS + X_PROBE_OFFSET_FROM_EXTRUDER)) min 18
    #define RIGHT_PROBE_BED_POSITION 190   //right < MAX_PROBE_X (min(X_MAX_POS, X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER)) max 200 
    #define FRONT_PROBE_BED_POSITION 20     //front > MIN_PROBE_Y (max(Y_MIN_POS, Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER)) min 0
    #define BACK_PROBE_BED_POSITION 190    //back  < MAX_PROBE_Y (min(Y_MAX_POS, Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER)) max 200
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_X_HOME_POS -18 //to put extruder 2 on x0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,150}  // default steps per unit for Ultimaker
